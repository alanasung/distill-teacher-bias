...
This note situates **When Distillation Makes Monitors Prefer Their Teacher** against the motivating literature for
[When Distillation Makes Monitors Prefer Their Teacher](https://github.com/alanasung/distill-teacher-bias).

## Positioning

Test whether distilled monitors systematically favor their teacher model's attributions under self-monitoring.

The design hypothesis is: Test whether distilled monitors systematically favor their teacher model's attributions under self-monitoring.
