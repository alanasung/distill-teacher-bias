"""Experiment stages for When Distillation Makes Monitors Prefer Their Teacher."""
...
from .distbias._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "When Distillation Makes Monitors Prefer Their Teacher", "claims_gated": True},
    )
